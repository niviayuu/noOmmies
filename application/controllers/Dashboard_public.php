...
/**
 * Dashboard Public - Tanpa Login (Untuk Testing)
 * Akses: http://localhost/jusbaru/dashboard_public
 */
class Dashboard_public extends CI_Controller {
    ...
    public function __construct() {
        ...
        // Set fake session untuk testing
        if (!$this->session->userdata('logged_in')) {
            $this->session->set_userdata(array(
                'user_id' => 1,
                'nama_lengkap' => 'Administrator (Test Mode)',
    ...
    public function index() {
        $data['title'] = 'Dashboard (Test Mode)';
